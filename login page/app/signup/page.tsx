  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(handleSignupSubmit)}>
        ...
        <p className="text-center text-sky-950 font-bold mb-1">
          {done ? "Registration completed,Go to Login page" : null}
        </p>
        <p className="text-center text-red-950 font-bold mb-1">
          {userExist && "User exists,Try with new mail id"}
        </p>
      ...
      <p>
        ...
        <Link href={"/"}>
          <span className="text-sky-950 font-bold mb-1 p-2">Login</span>
        </Link>{" "}
      </p>
    </div>
  );
